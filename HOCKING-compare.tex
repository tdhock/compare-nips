...
$r:\RR^p\rightarrow\RR$ and then make a prediction with the following
comparison function
\begin{equation}
...
We did a simulation in Figure~\ref{fig:norms}.

\begin{figure}[b!]
  \centering
  \input{figure-simulation}
  \caption{Application to simulated patterns $x,x'\in\RR^2$.}
  \label{fig:norms}
\end{figure}
